...
VALUES ('admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'admin@example.com', 'John Doe',
        'admin', 'Administrator of the site');

CREATE TABLE `registrations`
(
    `registration_uid` varchar(48)  NOT NULL DEFAULT uuid(),
    `username`         varchar(255) NOT NULL,
    `password`         varchar(255) NOT NULL,
    `email`            varchar(255) NOT NULL,
    `full_name`        varchar(255) NOT NULL,
