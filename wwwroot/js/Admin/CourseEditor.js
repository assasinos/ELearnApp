...
function CreateLesson(lessoncontent, lessontitle, courseuid) {
    $.ajax({
        url: "/api/admin/CourseEdit/CreateLesson",
        type: "PUT",
...
function UpdateLesson() {
    ...
    $.ajax({
        url: "/api/admin/CourseEdit/UpdateLesson",
        type: "PUT",
...
function UpdateCourse() {
    ...
    $.ajax({
        url: "/api/admin/CourseEdit/UpdateCourse",
        type: "PUT",
        data: form,
        success: function (data) {
...
$("#DeleteCourseBTN").click((e)=>{
    ...
    $("#ConfirmButton").one('click',()=>{
        $.ajax({
            url: "/api/admin/CourseEdit/DeleteCourse",
            type: "DELETE",
...
$("#DeleteLessonBTN").click((e)=>{
    ...
    $("#ConfirmButton").one('click',()=>{
        ...
        $.ajax({
            url: "/api/admin/CourseEdit/DeleteLesson",
            type: "DELETE",
